...
def render_table(_df):
    # import inside to guarantee availability and avoid name errors
    import streamlit as st
    # If a Styler was passed, try to unwrap to DataFrame so Streamlit can render
    try:
        from pandas.io.formats.style import Styler as _Styler
        if isinstance(_df, _Styler):
            _df = _df.data
    except Exception:
        pass
    st.table(_df)
